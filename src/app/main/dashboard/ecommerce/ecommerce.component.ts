...
export class EcommerceComponent implements OnInit {
  ...
  constructor(private _http: HttpClient,
    ...
    //const currentRole = this._authenticationService.currentRoleValue;
    //const currentRole=localStorage.getItem('role')
    this._authenticationService.currentUser.subscribe(x => { (this.currentUser = x);     console.log("currentUJser:", this.currentUser)

   // console.log(x.roleUser)
  //  this._http
 //.get<any>(`${environment.apiUrl}/findRolesByUsername/${x.username}`).subscribe(res =>{ 
      //console.log(res[0].authority)
  //  if (res[0].authority==="Fournisseur")
  //  {this.currentUser.role=Role.Fournisseur}
 ...
 this._authenticationService.currentRole.subscribe(y => { (this.currentRole = y)})

    this.isAdmin = this._authenticationService.isAdmin;
    console.log(this.isAdmin)
  // console.log(this.currentUser.roleUser)
